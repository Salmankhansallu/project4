(function ($) {
    ...
    if ($.fn.meanmenu) {
        $('nav#dropdown').meanmenu({
            siteLogo: "<div class='mobile-menu-nav-back'><a class='logo-mobile' href='https://becoblue.com/'><img src='assets/images/new_beco.jpg' alt='logo' class='img-fluid'  style='height:50px' /></a></div>"
        });
    }
