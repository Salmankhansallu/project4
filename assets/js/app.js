(function ($) {
    ...
    if ($.fn.meanmenu) {
        $('nav#dropdown').meanmenu({
            siteLogo: "<div class='mobile-menu-nav-back'><a class='logo-mobile' href='#'><img src='http://localhost/becoblue/assets/images/new_beco.jpg' alt='logo' class='img-fluid'  style='height:50px' /></a></div>"
        });
    }
    ...
    if ($("#googleMap").length) {
        window.onload = function () {
            ...
            var options = {
                ...
                center: new google.maps.LatLng(20.482865, 84.227288),
                zoom: 10,
